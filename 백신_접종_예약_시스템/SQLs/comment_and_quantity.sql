...
INSERT INTO VACCINE_COMMENT(content, vaccine_id, User_number, hospital_id, vaccine_rating, hospital_rating) values 
("맞고 이틀정도 열이났고 지금은 괜찮아요", 1, "950101-1122334", 1, 3, 3),
("대기시간이 너무 길었어요", 2, "921211-2202354", 2, 2, 3),
("딱히 부작용은 없었어요", 3, "881023-1108759", 2, 1, 3),
("맞고나서 팔이 엄청 아팠습니다", 4, "841027-1273759", 4, 2, 2),
("괜찮았어요", 1, "890831-2135739", 6, 4, 4),
("부작용이 심해서 죽을것 같았어요", 2, "890227-2013675", 7, 1, 2);
